...
} from "../../hooks/useAdaptivityConditionalRender/useAdaptivityConditionalRender";

const platformClassNames = {
    ios: styles['PanelHeader--ios'],
    android: styles['PanelHeader--android'],
    web: classNames(styles['PanelHeader--web'], 'vkuiInternalPanelHeader--web'),
};
...
const PanelHeaderIn = ({ before, children, typographyProps = {} }: PanelHeaderInProps) => {
    ...
    return (
        <RootComponent  className={styles['PanelHeader__in']}>
...
export const PanelHeader = ({
    ...
    const isFixed = fixed !== undefined ? fixed : !isWeb;
