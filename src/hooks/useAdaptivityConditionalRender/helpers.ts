import {SizeTypeValues, ViewHeightType, ViewWidth, ViewWidthType} from "../../utils/adaptivity/constants";
import {
    AdaptiveDeviceType, AdaptiveSizeType,
    AdaptiveViewWidth,
...
import {tryToCheckIsDesktop} from "../../utils/adaptivity/functions";
